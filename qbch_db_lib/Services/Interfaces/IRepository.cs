...
namespace Qbch_db_lib.Services.Interfaces
{
    ...
    public interface IRepository
    {
        ...
        /// <param name="ct"></param>
        /// <returns></returns>
        Task<bool> IsPermissionGranted(string? thumbprint, string? serviceName, CancellationToken? ct = null);
        ...
        Task<List<long>> GetSearchAllSubjects_old(string request);
        Task<XElement?> GetCalculationOfAmp_old(List<long> subjectIds);
        Task<XElement?> GetInnOgrnByThumbprint_old(string? thumbprint);
        Task<int?> GetAbonentKeyIdByPSRN_old(string? psrn);
    }
}
