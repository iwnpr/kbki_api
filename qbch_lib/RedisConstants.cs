...
public static class RedisConstants
{
    ...
    /// </summary>
    public const string DlRequestV3Scope = "dlrequest";
    /// <summary>
    /// Redis-scope (префикс ключей) для запросов /dlput версии 3.
    /// </summary>
    public const string DlPutV3Scope = "dlput";
    /// <summary>
    /// Redis-scope (префикс ключей) для запросов /dlanswer версии 3.
    /// </summary>
    public const string DlAnswerV3Scope = "dlanswer";
    /// <summary>
    /// Redis-scope (префикс ключей) для запросов /dlputanswer версии 3.
    /// </summary>
    public const string DlPutAnswerV3Scope = "dlputanswer";
}