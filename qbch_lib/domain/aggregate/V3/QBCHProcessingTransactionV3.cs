...
/// 
/// </summary>
public sealed class QBCHProcessingTransactionV3 : AggregateRoot
{
    /// <summary>
    /// Имя сервиса
    /// </summary>
    ...
    protected QBCHProcessingTransactionV3(Guid id, DateTime requestTime, ClentRequest clentRequest, Attachment attachment, List<QBCHRequisite> requisites) : base(id)
    {
    ...
    /// <param name="requisites"></param>
    /// <returns></returns>
    public static QBCHProcessingTransactionV3 Create(DateTime requestTime, ClentRequest clentRequest, Attachment attachment, List<QBCHRequisite> requisites)
    {
        return new QBCHProcessingTransactionV3(Guid.NewGuid(), requestTime, clentRequest, attachment, requisites);
    }
    ...
    /// <returns></returns>
    public QBCHProcessingTransactionV3 Complete(byte[] response, byte[] singnedResponse)
    {
        switch (Status)
        {
